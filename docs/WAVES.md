...
# Wave 3 — Структурный progress UI + локальные имена файлов
...
# Wave 4 — Имена плейлиста, кликабельные ссылки, retry per-item
...
| Wave | Задачи | Версия | ETA | Зависит от |
|---|---|---|---|---|
| 1 | G + H + I + I+ | v1.5.0-rc1 | ~2 ч (есть базовая работа) | — |
| 2 | L1 + L2 + L3 | v1.5.0-rc2 | ~1.5 дня | 1 |
| 3 | J1 + J4 | v1.5.0-rc3 | ~2 дня | 1 |
| 4 | J2 + J3 | v1.5.0 | ~1.5 дня | 3 |
| 5 | K | v1.6.0 | ~1 день | 1 |
